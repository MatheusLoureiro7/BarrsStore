...
class Pedido(models.Model):
    ...
    frete_transportadora = models.CharField(max_length=30, blank=True, default='')
    lalamove_quotation_id = models.CharField(max_length=120, blank=True, default='')
    lalamove_order_id = models.CharField(max_length=120, blank=True, default='')
    lalamove_tracking_url = models.URLField(blank=True, default='')
    status_lalamove = models.CharField(max_length=40, blank=True, default='')
